...
cluster.model <- function(model,B0=1,b0=NULL) {
  model$B0 <- B0
  model$b0 <- b0
  ...
  environment(estelle.logpb) <- environment(model$estelle.logpb)
  ...
  environment(stella.logpb) <- environment(model$stella.logpb)
