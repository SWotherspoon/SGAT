...
##' Simple movement model that assumes speeds have a Gamma distribution.
##'
...
##'
##' @title Simple Behavioural Model
...
##' @export
simple.behavioural.model <- function(beta,dt) {
...
satellite.model <- function(time,X,
  ...
  behavioural.model <- simple.behavioural.model(beta,dt)
