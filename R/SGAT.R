...
##' @param s an array of location samples generated by
##' \code{estelle.metropolis} or \code{stella.metropolis}.
##' @param to.crs an object of class \code{CRS} defining the
##' projection to be transformed to.
##' @param from.crs \code{NULL} or an object of class \code{CRS}
##' defining the original projection.
